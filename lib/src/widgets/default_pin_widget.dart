...
class DefaultPinWidget extends StatelessWidget {
  ...
  const DefaultPinWidget({required this.pinState, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      transform: Matrix4.translationValues(0.0, pinIsBeingDragged ? -8.0 : 0.0, 0.0),
      child: Icon(iconData, size: 72.0, color: iconColor),
    );
  }
}
