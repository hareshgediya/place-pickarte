...
PlacesSearchResult _$PlacesSearchResultFromJson(Map<String, dynamic> json) => PlacesSearchResult(
  ...
  openingHours: json['opening_hours'] == null
      ? null
      : OpeningHoursDetail.fromJson(json['opening_hours'] as Map<String, dynamic>),
...
OpeningHoursPeriodDate _$OpeningHoursPeriodDateFromJson(Map<String, dynamic> json) =>
    OpeningHoursPeriodDate(day: (json['day'] as num).toInt(), time: json['time'] as String);

Map<String, dynamic> _$OpeningHoursPeriodDateToJson(OpeningHoursPeriodDate instance) =>
...
Photo _$PhotoFromJson(Map<String, dynamic> json) => Photo(
  ...
  htmlAttributions:
      (json['html_attributions'] as List<dynamic>?)?.map((e) => e as String).toList() ?? [],
);
...
AlternativeId _$AlternativeIdFromJson(Map<String, dynamic> json) =>
    AlternativeId(placeId: json['place_id'] as String, scope: json['scope'] as String);
...
Map<String, dynamic> _$PlacesDetailsResponseToJson(PlacesDetailsResponse instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$PlacesAutocompleteResponseToJson(PlacesAutocompleteResponse instance) =>
    <String, dynamic>{
      'status': instance.status,
      'error_message': instance.errorMessage,
...
Term _$TermFromJson(Map<String, dynamic> json) =>
    Term(offset: json['offset'] as num, value: json['value'] as String);
...
MatchedSubstring _$MatchedSubstringFromJson(Map<String, dynamic> json) =>
    MatchedSubstring(offset: json['offset'] as num, length: json['length'] as num);
...
Map<String, dynamic> _$StructuredFormattingToJson(StructuredFormatting instance) =>
    <String, dynamic>{
